...
let studentTable = $("#studentTable");
  $(document).ready(function() {
    ...
    let buttonAddStudent = $("#addStudent");
    buttonAddStudent.click(addStudent);
    let buttonCalculateAverage = $("#calculateAverage");
    buttonCalculateAverage.click(calculateAverage);
    let buttonDetermineRank = $("#determineRank");
    buttonDetermineRank.click(determineRank);
  });
  function addStudent() {
    let name = $("#name").val();
    let dob = $("#dob").val();
